...
import { fetchTopRatedMovies } from "../../redux/services";
  ...
  return (
    <div>
      <Helmet>
        ...
        <meta name="description" content="Top rated movies description" />
      </Helmet>
      ...
      <div className="flex my-5 pb-5 items-center text-xl justify-center font-bold text-yellow-500">
        <button
          onClick={() => dispatch(fetchTopRatedMovies(setPage(page - 1)))}
          disabled={page === 1}
